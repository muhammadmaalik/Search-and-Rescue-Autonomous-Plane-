...
To move beyond basic GPS flight, this airframe is engineered to carry and power an **Nvidia Jetson Orin Nano** edge-computing module. 
...
The immediate goal of this phase was to successfully integrate custom hardware routing, establish reliable serial digital communications, and validate autonomous flight modes on a custom-designed airframe.
...
* **Edge AI Computer:** Nvidia Jetson Orin Nano
* **Telemetry:** 3DR Telemetry Radio (57600 baud) for remote Ground Control Station data
* **Power System:** 14.8V 4S2P 10000mAh LiPo providing high-capacity endurance power to logic, payload, and servos
* **Airframe:** Custom 3D-Printed Fixed-Wing 
* **Propulsion:** Heavy-Lift Brushless Motor (2814/3536 class) paired with an 80A ESC
...
Standard off-the-shelf mounts were insufficient for the required hardware layout. I utilized Fusion 360 to design and manufacture custom mounting solutions to secure the flight controller, Nvidia Jetson payload, and organize the telemetry components. 
...
| :--- | :--- | 
| **Flight Controller** | AtomRC F405 NAVI Wing | 
| **AI Processing Node** | Nvidia Jetson Orin Nano | 
| **Transmitter/Receiver** | FlySky FS-i6 + FS-iA6B | 
| **Telemetry System** | 3DR Radio V2 | 
| **ESC** | 80 Amp Brushless ESC |
| **Battery** | 4S2P 14.8V 10000mAh LiPo | 
| **Airframe** | Custom 3D-Printed Wing | 
